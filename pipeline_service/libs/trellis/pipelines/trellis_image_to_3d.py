...
class TrellisImageTo3DPipeline(Pipeline):
    ...
    def _init_image_cond_model(self, name: str = 'dinov2_vitg14_reg'):
        """
        Initialize the image conditioning model.
        
        Args:
            name: DINOv2 model name. Default is 'dinov2_vitg14_reg' (Giant with registers, 1.1B params).
                  Other options: 'dinov2_vits14', 'dinov2_vitb14', 'dinov2_vitl14', 'dinov2_vitg14',
                  or add '_reg' suffix for models with registers (better performance).
        """
        print(f"Loading DINOv2 image conditioning model: {name}")
